 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"za.gov.sars.sms.persistence"}, transactionManagerRef = "transactionManager")
@ComponentScan(basePackages = {"za.gov.sars.sms"})
...
public class TestDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(){
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("za.gov.sars.sms.domain");
